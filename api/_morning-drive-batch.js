...
Each MUST be: held by the Metropolitan Museum of Art or the Art Institute of Chicago (the only two collections searched — no MoMA, Louvre, Orsay, Rijksmuseum or Uffizi, so no Starry Night or Mona Lisa); out of copyright, which in practice means made before about 1900 (American Gothic and Nighthawks are at the Art Institute but still in copyright); and entirely appropriate for a 7-year-old. Landscapes, animals, boats, dancers, night skies, children, gardens and everyday scenes are ideal. NOT suitable, however famous: anything with nudity (including classical and mythological nudes), any attack, battle, hunt, shipwreck or drowning, anything with a body, a skull or blood, and any religious martyrdom. Copley's "Watson and the Shark" is a real example of what NOT to choose — a boy, naked, being attacked by a shark. Famous, out of copyright, in the Met, and completely wrong for this.
